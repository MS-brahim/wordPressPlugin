...
class Save_color_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'save_color-admin.css', plugin_dir_url( __FILE__ ) . 'css/save_color-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'save_color-admin.js', plugin_dir_url( __FILE__ ) . 'js/save_color-admin.js', array( 'jquery' ), $this->version, true );
		wp_enqueue_script( 'jquery-3.3.1.slim.min.js', plugin_dir_url( __FILE__ ) . 'js/jquery-3.3.1.slim.min.js', array( 'jquery' ), $this->version, true );
